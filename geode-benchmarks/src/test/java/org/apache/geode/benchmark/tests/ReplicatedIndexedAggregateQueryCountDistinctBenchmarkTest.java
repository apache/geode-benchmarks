...
public class ReplicatedIndexedAggregateQueryCountDistinctBenchmarkTest {
  private File folder;
  ...
  public void benchmarkRunsSuccessfully() throws Exception {
    ReplicatedIndexedAggregateQueryCountDistinctBenchmark test =
        new ReplicatedIndexedAggregateQueryCountDistinctBenchmark();
