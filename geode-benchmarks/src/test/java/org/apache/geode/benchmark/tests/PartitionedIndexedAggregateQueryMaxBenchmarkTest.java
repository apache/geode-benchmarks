...
public class PartitionedIndexedAggregateQueryMaxBenchmarkTest {
  private File folder;
  ...
  public void benchmarkRunsSuccessfully() throws Exception {
    PartitionedIndexedAggregateQueryMaxBenchmark test =
        new PartitionedIndexedAggregateQueryMaxBenchmark();
