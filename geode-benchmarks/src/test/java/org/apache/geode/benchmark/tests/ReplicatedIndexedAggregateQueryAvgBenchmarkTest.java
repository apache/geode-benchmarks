...
public class ReplicatedIndexedAggregateQueryAvgBenchmarkTest {
  private File folder;
  ...
  public void benchmarkRunsSuccessfully() throws Exception {
    ReplicatedIndexedAggregateQueryAvgBenchmark test =
        new ReplicatedIndexedAggregateQueryAvgBenchmark();
