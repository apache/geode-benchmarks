...
public class ReplicatedIndexedAggregateQueryCountBenchmarkTest {
  private File folder;
  ...
  public void benchmarkRunsSuccessfully() throws Exception {
    ReplicatedIndexedAggregateQueryCountBenchmark test =
        new ReplicatedIndexedAggregateQueryCountBenchmark();
