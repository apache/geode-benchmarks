...
public class ReplicatedIndexedAggregateQueryMinBenchmarkTest {
  private File folder;
  ...
  public void benchmarkRunsSuccessfully() throws Exception {
    ReplicatedIndexedAggregateQueryMinBenchmark test =
        new ReplicatedIndexedAggregateQueryMinBenchmark();
