...
public class PartitionedIndexedAggregateQuerySumDistinctBenchmarkTest {
  private File folder;
  ...
  public void benchmarkRunsSuccessfully() throws Exception {
    PartitionedIndexedAggregateQuerySumDistinctBenchmark test =
        new PartitionedIndexedAggregateQuerySumDistinctBenchmark();
