...
public class ReplicatedIndexedAggregateQuerySumBenchmarkTest {
  private File folder;
  ...
  public void benchmarkRunsSuccessfully() throws Exception {
    ReplicatedIndexedAggregateQuerySumBenchmark test =
        new ReplicatedIndexedAggregateQuerySumBenchmark();
