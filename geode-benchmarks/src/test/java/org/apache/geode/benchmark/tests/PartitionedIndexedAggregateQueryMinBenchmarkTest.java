...
public class PartitionedIndexedAggregateQueryMinBenchmarkTest {
  private File folder;
  ...
  public void benchmarkRunsSuccessfully() throws Exception {
    PartitionedIndexedAggregateQueryMinBenchmark test =
        new PartitionedIndexedAggregateQueryMinBenchmark();
