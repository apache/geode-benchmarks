...
public class PartitionedIndexedAggregateQueryCountDistinctBenchmarkTest {
  private File folder;
  ...
  public void benchmarkRunsSuccessfully() throws Exception {
    PartitionedIndexedAggregateQueryCountDistinctBenchmark test =
        new PartitionedIndexedAggregateQueryCountDistinctBenchmark();
