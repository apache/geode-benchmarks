...
public class PartitionedIndexedAggregateQueryAvgBenchmarkTest {
  private File folder;
  ...
  public void benchmarkRunsSuccessfully() throws Exception {
    PartitionedIndexedAggregateQueryAvgBenchmark test =
        new PartitionedIndexedAggregateQueryAvgBenchmark();
