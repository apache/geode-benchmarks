...
public class PartitionedIndexedAggregateQueryAvgDistinctBenchmarkTest {
  private File folder;
  ...
  public void benchmarkRunsSuccessfully() throws Exception {
    PartitionedIndexedAggregateQueryAvgDistinctBenchmark test =
        new PartitionedIndexedAggregateQueryAvgDistinctBenchmark();
