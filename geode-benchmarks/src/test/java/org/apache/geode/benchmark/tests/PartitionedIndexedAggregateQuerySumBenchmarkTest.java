...
public class PartitionedIndexedAggregateQuerySumBenchmarkTest {
  private File folder;
  ...
  public void benchmarkRunsSuccessfully() throws Exception {
    PartitionedIndexedAggregateQuerySumBenchmark test =
        new PartitionedIndexedAggregateQuerySumBenchmark();
