...
public class ReplicatedIndexedAggregateQueryAvgDistinctBenchmarkTest {
  private File folder;
  ...
  public void benchmarkRunsSuccessfully() throws Exception {
    ReplicatedIndexedAggregateQueryAvgDistinctBenchmark test =
        new ReplicatedIndexedAggregateQueryAvgDistinctBenchmark();
