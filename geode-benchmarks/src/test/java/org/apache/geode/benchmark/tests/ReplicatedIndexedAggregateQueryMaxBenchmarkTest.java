...
public class ReplicatedIndexedAggregateQueryMaxBenchmarkTest {
  private File folder;
  ...
  public void benchmarkRunsSuccessfully() throws Exception {
    ReplicatedIndexedAggregateQueryMaxBenchmark test =
        new ReplicatedIndexedAggregateQueryMaxBenchmark();
